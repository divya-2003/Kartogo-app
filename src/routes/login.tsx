...
function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#010d3a] px-4">
      {/* Brand */}
      <div className="mb-8 flex flex-col items-center gap-3">
        <div className="grid h-20 w-20 place-items-center overflow-hidden rounded-2xl bg-[#010d3a] shadow-pop">
