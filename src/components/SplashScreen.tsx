...
import logo from "@/assets/kartigo-logo.png";
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center px-6 text-center">
        <img src={logo} alt="" width={96} height={96} className="h-24 w-24 animate-splash-pop rounded-3xl object-contain shadow-pop" />
